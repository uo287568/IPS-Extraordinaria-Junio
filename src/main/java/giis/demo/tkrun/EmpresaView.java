...
public class EmpresaView {
	...
	private void initialize() {
		...
		frmRegistroEmpresa.setBounds(0, 0, 703, 422);
		frmRegistroEmpresa.setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
		frmRegistroEmpresa.getContentPane().setLayout(new MigLayout("", "[grow]", "[][][][][][][][][grow][][][]"));
		...
		frmRegistroEmpresa.getContentPane().add(lbInfoE, "cell 0 1");
		...
		frmRegistroEmpresa.getContentPane().add(lbInfoR, "cell 0 3");
		
		pnReceptor = new JPanel();
		frmRegistroEmpresa.getContentPane().add(pnReceptor, "cell 0 4,grow");
		...
		frmRegistroEmpresa.getContentPane().add(lbPaquete, "cell 0 5");
		
		pnPaquete = new JPanel();
		frmRegistroEmpresa.getContentPane().add(pnPaquete, "cell 0 6,grow");
		...
		frmRegistroEmpresa.getContentPane().add(lbInstrucciones, "cell 0 7");
		
		txaComentarios = new JTextArea();
		frmRegistroEmpresa.getContentPane().add(txaComentarios, "cell 0 8,grow");
		
		JLabel lbPrecio = new JLabel("Precio final en euros (€):");
		lbPrecio.setFont(new Font("Tahoma", Font.PLAIN, 13));
		frmRegistroEmpresa.getContentPane().add(lbPrecio, "cell 0 9");
		
		JPanel pnPrecio = new JPanel();
		frmRegistroEmpresa.getContentPane().add(pnPrecio, "cell 0 10,grow");
		...
		frmRegistroEmpresa.getContentPane().add(panel, "cell 0 11,grow");
